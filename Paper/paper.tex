...
Voor het schrijven van de code\footnote{Alle code is beschikbaar op \\ https://gitlab.com/smartled-displays/smartled-displays} gebruiken we de standaard Arduino IDE.
