...
Conventionele LED-displays komen vooral vlak voor en dit is helaas niet echt mogelijk met SmartLED-displays aangezien zo geen communicatie mogelijk is. Hieruit besluiten we dat SmartLED-displays geen alternatief zijn voor conventionele LED-displays. Ze bezitten echter wel bepaalde eigenschappen die ze niet alleen bruikbaar maar ook bijzonder maken. Ze zijn flexibel en modulair aangezien de individuele SmartLEDs zonder id's werken en enkel communiceren met andere SmartLEDs die op dat moment binnen bereik zijn. Ze zijn ook interactief, zoals aangetoond reageren ze op een lichtpen en kan zo het programma veranderd worden. Ten slotte de gevolgen van eventuelen problemen met een enkele SmartLED zeer beperkt.
Hieruit concluderen we dat SmartLED-displays interactief gebruikt kunnen worden als simpele, vlakke displays zonder onderlinge communicatie. Daarnaast kunnen ze in andere vormen wel signalen doorgeven en dus meer als 1 geheel functioneren.
